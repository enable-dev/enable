$PBExportHeader$panel_enable_dynamicproperties.sru
$PBExportComments$OBFUSCATED UNDISCLOSED SOURCE CODE. ©2016 Enable Development LTD. All rights reserved.
forward
global type panel_enable_dynamicproperties from vc_enable_panel
end type
type xxbmyhh_4q2b_mgishzsp0 from datawindow within panel_enable_dynamicproperties
end type
type xfkce7ynhqsz0hctm from datawindow within panel_enable_dynamicproperties
end type
type p_focus from picture within panel_enable_dynamicproperties
end type
type x01qsuv_3cx5ull73ygix from datawindow within panel_enable_dynamicproperties
end type
type x0u7t7tq_vy8kjph5h83endkvi1jw93 from datawindow within panel_enable_dynamicproperties
end type
type xchgh6i7s71frw from commandbutton within panel_enable_dynamicproperties
end type
type xiumm9t7w_1lj7 from datawindow within panel_enable_dynamicproperties
end type
end forward                              
...
xiumm9t7w_1lj7 xiumm9t7w_1lj7
end type
global panel_enable_dynamicproperties panel_enable_dynamicproperties                  
...
on panel_enable_dynamicproperties.create
int iCurrent
call super::create
...
this.xiumm9t7w_1lj7=create xiumm9t7w_1lj7
...
this.Control[iCurrent+7]=this.xiumm9t7w_1lj7
end on                           

on panel_enable_dynamicproperties.destroy
call super::destroy
...
destroy(this.xiumm9t7w_1lj7)
end on                        

event ue_resize_width;call super::ue_resize_width;
integer xpnajmkyj5f0se
...
xchgh6i7s71frw.x = xpnajmkyj5f0se - xchgh6i7s71frw.width - 20            
...
lds.Filter()
lds.rowscopy(1, lds.Rowcount( ), Primary!, xxbmyhh_4q2b_mgishzsp0, 1, Primary!)
lds.rowscopy(1, lds.FilteredCount(), Filter!, xxbmyhh_4q2b_mgishzsp0, 1, Filter!)   
   ...
   if lstr.x55lf4dbu99n<>'' then
      ...
      if xxbmyhh_4q2b_mgishzsp0.RowCount() > 0 then 
               ...
               for x0zv7t5_qn_968ymr9tipyzn = 1 to xdqzc8pqgr4m
                                                      xxbmyhh_4q2b_mgishzsp0.SetItem(x0zv7t5_qn_968ymr9tipyzn,'s_value_1',lower(xxbmyhh_4q2b_mgishzsp0.GetItemString(x0zv7t5_qn_968ymr9tipyzn,'s_value_1')))
...
if xmrg01ushi84kyp4fa5pv>0 then   
               ...
               choose case li
                                    case 1 
                                                                  if ienable.xc9l4tg3acfz(xxbmyhh_4q2b_mgishzsp0)=0 then
...
x0u7t7tq_vy8kjph5h83endkvi1jw93.Y = newheight - x0u7t7tq_vy8kjph5h83endkvi1jw93.Height - 10 - xchgh6i7s71frw.height - 10
xfkce7ynhqsz0hctm.Y = newheight - xfkce7ynhqsz0hctm.Height - 10  - xchgh6i7s71frw.height - 10
x01qsuv_3cx5ull73ygix.Y = newheight - x01qsuv_3cx5ull73ygix.Height - 10 - xchgh6i7s71frw.height - 10   
...
type p_scroll from vc_enable_panel`p_scroll within panel_enable_dynamicproperties
end type            
...
string title = "none"
string dataobject = "xuuyja2c23xf"
...
event buttonclicked;if row>0 and dwo.name="b_delete" then                              
...
boolean bringtotop = true
string title = "none"
string dataobject = "xb5hj5nzbu9chhkm6__ct1r4v"
boolean hscrollbar = true
...
integer taborder = 20
string title = "none"
string dataobject = "xt5ntqr18x20nzm99"
boolean border = false
boolean livescroll = true
end type      
...
boolean bringtotop = true
string title = "none"
string dataobject = "xbcrjhpya27ubwbnjr92ci9n2my"
boolean hscrollbar = true
boolean border = false
boolean livescroll = true
end type                           
...
string xt3erwx1pka7_dj_in_j0dg, xhs0fvmlu_7mfz_15ygauhkegm, xhc_r96b4lrvdp8s9p7fa1_bwtyt_                  
xc0i0sn4wm2phzlk2dtnu59z89ikq5b = integer(xxbmyhh_4q2b_mgishzsp0.Describe("DataWindow.Column.Count"))
...
xiumm9t7w_1lj7.Reset()
if xxbmyhh_4q2b_mgishzsp0.RowCount() > 0 then
      for x0zv7t5_qn_968ymr9tipyzn = 1  to xxbmyhh_4q2b_mgishzsp0.RowCount()
                        x8s2bl9ys817blu = xiumm9t7w_1lj7.InsertRow(0)
                                       for xn6i3k0g5xsgsf = 1 to xc0i0sn4wm2phzlk2dtnu59z89ikq5b
                                                      xiumm9t7w_1lj7.SetItem(x8s2bl9ys817blu, xn6i3k0g5xsgsf, xxbmyhh_4q2b_mgishzsp0.Object.Data[x0zv7t5_qn_968ymr9tipyzn, xn6i3k0g5xsgsf])
                                                      next
            xt3erwx1pka7_dj_in_j0dg = "lower(s_property) = lower('"+xxbmyhh_4q2b_mgishzsp0.GetItemString(x0zv7t5_qn_968ymr9tipyzn, 's_value_1')+"') and lower(s_type) = lower('"+xxbmyhh_4q2b_mgishzsp0.GetItemString(x0zv7t5_qn_968ymr9tipyzn, 's_value_2')+"')"
                     ...
                     xiumm9t7w_1lj7.SetItem(x8s2bl9ys817blu, 'display', x802lpj1l8f3i0zek29q9ys.GetItemString(xbu6xr0c_ebay,'s_display'))
                                       xiumm9t7w_1lj7.SetItem(x8s2bl9ys817blu, 'code', x802lpj1l8f3i0zek29q9ys.GetItemString(xbu6xr0c_ebay,'s_code'))
                                                                  xhs0fvmlu_7mfz_15ygauhkegm = Replace(x802lpj1l8f3i0zek29q9ys.GetItemString(xbu6xr0c_ebay,'s_formula'), pos(x802lpj1l8f3i0zek29q9ys.GetItemString(xbu6xr0c_ebay,'s_formula'),'@val'), len('@val'), 's_value_5')
                                                                              xiumm9t7w_1lj7.SetItem(x8s2bl9ys817blu, 'c_value', xiumm9t7w_1lj7.Describe("Evaluate('"+xhs0fvmlu_7mfz_15ygauhkegm+"', " + string(x8s2bl9ys817blu) + ")"))
                                          xiumm9t7w_1lj7.SetItem(x8s2bl9ys817blu, 'e_value', xiumm9t7w_1lj7.Describe("Evaluate('"+xhs0fvmlu_7mfz_15ygauhkegm+"', " + string(x8s2bl9ys817blu) + ")"))
                                                                  if lower(x802lpj1l8f3i0zek29q9ys.GetItemString(xbu6xr0c_ebay,'s_control')) = 'checkbox' then
                                                xiumm9t7w_1lj7.SetItem(x8s2bl9ys817blu, 'control', 'C')
                                                               if integer(xiumm9t7w_1lj7.object.c_value[x8s2bl9ys817blu]) = 1 then
                                                                                          xiumm9t7w_1lj7.SetItem(x8s2bl9ys817blu, 'e_value', '[x]')
                                                   else
                                                                                 xiumm9t7w_1lj7.SetItem(x8s2bl9ys817blu, 'e_value', '[ ]')
                                                                                    end if
                                                            else
                                                      xiumm9t7w_1lj7.SetItem(x8s2bl9ys817blu, 'control', 'E')
                                       end if
                                       else
                                 xhc_r96b4lrvdp8s9p7fa1_bwtyt_ = xxbmyhh_4q2b_mgishzsp0.GetItemString(x0zv7t5_qn_968ymr9tipyzn, 's_value_1')
                                       xiumm9t7w_1lj7.SetItem(x8s2bl9ys817blu, 'display', upper(mid(xhc_r96b4lrvdp8s9p7fa1_bwtyt_,1,1))+mid(xhc_r96b4lrvdp8s9p7fa1_bwtyt_,2))
                                             if lower(xxbmyhh_4q2b_mgishzsp0.GetItemString(x0zv7t5_qn_968ymr9tipyzn, 's_value_2')) = 'boolean' then
                                                                           xiumm9t7w_1lj7.SetItem(x8s2bl9ys817blu, 'control', 'C')
                           if lower(xxbmyhh_4q2b_mgishzsp0.GetItemString(x0zv7t5_qn_968ymr9tipyzn, 's_value_5')) = 'yes' or lower(xxbmyhh_4q2b_mgishzsp0.GetItemString(x0zv7t5_qn_968ymr9tipyzn, 's_value_5')) = 'true' then
                                                               xiumm9t7w_1lj7.SetItem(x8s2bl9ys817blu, 'c_value', '1')
                                                                              xiumm9t7w_1lj7.SetItem(x8s2bl9ys817blu, 'e_value', '[x]')
                        else
                                                                  xiumm9t7w_1lj7.SetItem(x8s2bl9ys817blu, 'c_value', '0')
                                                                                    xiumm9t7w_1lj7.SetItem(x8s2bl9ys817blu, 'e_value', '[ ]')
                                                                     end if
                                                                  else
                                                                                                   xiumm9t7w_1lj7.SetItem(x8s2bl9ys817blu, 'control', 'E')
                                                                                                               xiumm9t7w_1lj7.SetItem(x8s2bl9ys817blu, 'e_value', xiumm9t7w_1lj7.Describe("Evaluate('s_value_5', " + string(x8s2bl9ys817blu) + ")"))
                              end if
                           end if
                                                if xxbmyhh_4q2b_mgishzsp0.isSelected(x0zv7t5_qn_968ymr9tipyzn) then
                                                                                    xiumm9t7w_1lj7.SelectRow(x8s2bl9ys817blu,true)
                     end if
         next
end if                        
xkje956lf8zjag6mi08icwuyq1tb.x52dtrrkk04vzbmstcrck1p49mj3m[1] = ienable
xkje956lf8zjag6mi08icwuyq1tb.x52dtrrkk04vzbmstcrck1p49mj3m[2] = xiumm9t7w_1lj7            
